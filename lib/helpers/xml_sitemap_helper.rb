...
# This was pull from the nanoc/nanoc-xml_sitemap repository on github, changes
# have been made to it's behavior to force it to respect updated_at attribute
# on any items that it appears on.
