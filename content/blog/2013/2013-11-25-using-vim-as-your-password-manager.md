...
date: 2013-11-25T15:10:46-05:00

aliases:
  - /blog/2013/11/using-vim-as-your-password-manager/
...
services that are quite solid and respectable, to native desktop apps.
...
uses a remarkably weak algorithm called [pkzip][1] which isn't secure enough
...
If this still isn't strong enough for your tastes, the [vim wiki][2] has some
...
***Update***: I received a recommendation from a user named [sigzero][3] over
...
this time from [NinlyOne][4].  At their recommendation, I've prepended the
...
[1]: https://en.wikipedia.org/wiki/PKZIP
[2]: http://vim.wikia.com/wiki/Encryption
[3]: http://www.reddit.com/r/vim/comments/1rg3ji/wrote_up_my_thoughts_on_using_vim_as_a_password/cdn20o8
[4]: http://www.reddit.com/r/vim/comments/1rg3ji/wrote_up_my_thoughts_on_using_vim_as_a_password/cdnn94z
