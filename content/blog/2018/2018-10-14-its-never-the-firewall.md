...
aliases:
  - /blog/2018/10/its-never-the-firewall/
slug: its-never-the-firewall
...
Identify the current configured limits for that process (replace `<PID>` with
the pid you just found):
...
[1]: it_is_never_the_firewall.pdf
