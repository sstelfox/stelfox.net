...
date: 2019-10-25T11:26:31-05:00

aliases:
  - /blog/2019/10/fixing-hung-nginx-workers/
...
![Graph showing Nginx memory usage. The graph goes from chaotic to steady][1]
...
applications, its not uncommon for them to run [a minimal init container][2],
...
An option was added in the [Nginx core module][4] to handle situations where
...
[1]: nginx_memory_consumption.png
[2]: https://github.com/krallin/tini
[3]: https://forum.nginx.org/read.php?2,262403,262403
[4]: http://nginx.org/en/docs/ngx_core_module.html#worker_shutdown_timeout
