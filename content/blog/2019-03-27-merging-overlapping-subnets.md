...
slug: merging-overlapping-subnets
---
...
But in this story there is a darkness looming. Communication was not everything either of them desired. There were secret things that couldn't be said in public forums of the internet but they both desperately wanted share. There was a solution... But it involved dark magic.
...
Next up there are some specific sysctl settings that need to be adjusted for the tunneled packets to not be rejected by the kernel. The reason behind the sysctl settings is pretty well [documented on LibreSwan's FAQ](https://libreswan.org/wiki/FAQ) if you're curious for why they're needed.
...
You'll want to verify the state of the tunnel reflect it has fully come up:
...
Either [send me an email](mailto:sam@stelfox.net) or [open an issue](https://github.com/sstelfox/stelfox.net/issues/new) for my website's public repository. Cheers!
