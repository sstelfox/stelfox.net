...
date: 2012-02-14T18:08:51Z

aliases:
  - /blog/2012/02/rubys-xmlrpc-client-and-ssl/
slug: rubys-xmlrpc-client-and-ssl
...
ones such as VeriSign, and [DigiNotar][1]. Some of which were [proven][2] to
...
in my head scream in despair. I asked on [StackOverflow][3] for a good
solution. When I asked I didn't have a good grasp on how Ruby was handling SSL
certificates at all. The thorough answer from [emboss][4] didn't quite answer
...
The server I was connecting to was using a RapidSSL certificate, who has been
verified by GeoTrust. You want to grab their certificates base64 encoded in PEM
format. Stick them all in a `ca.crt` file.
...
[1]: https://web.archive.org/web/20120418062943/http://www.symantec.com:80/connect/blogs/diginotar-ssl-breach-update
[2]: http://nakedsecurity.sophos.com/2011/08/29/falsely-issued-google-ssl-certificate-in-the-wild-for-more-than-5-weeks/
[3]: http://stackoverflow.com/questions/9199660/why-is-ruby-unable-to-verify-an-ssl-certificate
[4]: http://stackoverflow.com/a/9238221/95114
